...
if("FALSE" STREQUAL "TRUE")
  set(std_msgs_SOURCE_PREFIX /home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/work/core2-32-sbr-linux/std-msgs/0.5.10-r0/std_msgs-0.5.10)
  set(std_msgs_DEVEL_PREFIX /home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/work/core2-32-sbr-linux/std-msgs/0.5.10-r0/build/devel)
  set(std_msgs_INSTALL_PREFIX "")
  set(std_msgs_PREFIX ${std_msgs_DEVEL_PREFIX})
else()
  set(std_msgs_SOURCE_PREFIX "")
  set(std_msgs_DEVEL_PREFIX "")
  set(std_msgs_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND CMAKE_CROSSCOMPILING)
      ...
      if(NOT include_dir_path)
        message(FATAL_ERROR "Project 'std_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in any of the root filesystems.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
      endif()
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'std_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
