...
if("FALSE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/work/core2-32-sbr-linux/roslang/1.11.13-r0/ros-1.11.13/core/roslang)
  set(roslang_DEVEL_PREFIX /home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/work/core2-32-sbr-linux/roslang/1.11.13-r0/build/devel)
  set(roslang_INSTALL_PREFIX "")
  set(roslang_PREFIX ${roslang_DEVEL_PREFIX})
else()
  set(roslang_SOURCE_PREFIX "")
  set(roslang_DEVEL_PREFIX "")
  set(roslang_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND CMAKE_CROSSCOMPILING)
      ...
      if(NOT include_dir_path)
        message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does not exist in any of the root filesystems.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
      set(include "${include_dir_path}/${idir_name}")
    elseif(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${roslang_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(roslang_LIBRARIES ${roslang_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${roslang_dep}_LIBRARIES})
  _list_append_deduplicate(roslang_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(roslang_LIBRARIES ${roslang_LIBRARIES})
