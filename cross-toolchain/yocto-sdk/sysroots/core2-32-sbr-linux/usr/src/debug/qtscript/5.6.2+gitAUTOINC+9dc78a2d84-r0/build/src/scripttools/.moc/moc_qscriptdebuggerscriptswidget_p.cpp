...
#include "../../../../git/src/scripttools/debugging/qscriptdebuggerscriptswidget_p.h"
...
struct qt_meta_stringdata_QScriptDebuggerScriptsWidget_t {
    QByteArrayData data[3];
    char stringdata0[50];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScriptDebuggerScriptsWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QScriptDebuggerScriptsWidget_t qt_meta_stringdata_QScriptDebuggerScriptsWidget = {
    {
QT_MOC_LITERAL(0, 0, 28), // "QScriptDebuggerScriptsWidget"
QT_MOC_LITERAL(1, 29, 19), // "_q_onCurrentChanged"
QT_MOC_LITERAL(2, 49, 0) // ""

    },
    "QScriptDebuggerScriptsWidget\0"
...
const QMetaObject QScriptDebuggerScriptsWidget::staticMetaObject = {
    { &QScriptDebuggerScriptsWidgetInterface::staticMetaObject, qt_meta_stringdata_QScriptDebuggerScriptsWidget.data,
      qt_meta_data_QScriptDebuggerScriptsWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScriptDebuggerScriptsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScriptDebuggerScriptsWidget.stringdata0))
