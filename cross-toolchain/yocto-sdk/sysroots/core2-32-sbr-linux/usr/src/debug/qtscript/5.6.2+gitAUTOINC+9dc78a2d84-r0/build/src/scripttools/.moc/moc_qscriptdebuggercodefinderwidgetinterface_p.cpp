...
#include "../../../../git/src/scripttools/debugging/qscriptdebuggercodefinderwidgetinterface_p.h"
...
void QScriptDebuggerCodeFinderWidgetInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScriptDebuggerCodeFinderWidgetInterface::findRequest)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QScriptDebuggerCodeFinderWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebuggerCodeFinderWidgetInterface.data,
      qt_meta_data_QScriptDebuggerCodeFinderWidgetInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
