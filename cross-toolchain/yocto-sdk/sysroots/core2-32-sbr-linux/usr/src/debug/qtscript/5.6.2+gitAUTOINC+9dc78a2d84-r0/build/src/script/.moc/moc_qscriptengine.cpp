...
#include "../../../../git/src/script/api/qscriptengine.h"
...
void QScriptEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QScriptEngine::*_t)(const QScriptValue & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScriptEngine::signalHandlerException)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QScriptEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QScriptEngine.data,
      qt_meta_data_QScriptEngine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
