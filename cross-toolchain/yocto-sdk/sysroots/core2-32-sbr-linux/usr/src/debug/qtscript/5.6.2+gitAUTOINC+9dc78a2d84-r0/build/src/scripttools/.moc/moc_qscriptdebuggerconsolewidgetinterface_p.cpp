...
#include "../../../../git/src/scripttools/debugging/qscriptdebuggerconsolewidgetinterface_p.h"
...
struct qt_meta_stringdata_QScriptDebuggerConsoleWidgetInterface_t {
    QByteArrayData data[4];
    char stringdata0[60];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScriptDebuggerConsoleWidgetInterface_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QScriptDebuggerConsoleWidgetInterface_t qt_meta_stringdata_QScriptDebuggerConsoleWidgetInterface = {
    {
QT_MOC_LITERAL(0, 0, 37), // "QScriptDebuggerConsoleWidgetI..."
QT_MOC_LITERAL(1, 38, 11), // "lineEntered"
QT_MOC_LITERAL(2, 50, 0), // ""
QT_MOC_LITERAL(3, 51, 8) // "contents"

    },
    "QScriptDebuggerConsoleWidgetInterface\0"
    "lineEntered\0\0contents"
};
...
void QScriptDebuggerConsoleWidgetInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QScriptDebuggerConsoleWidgetInterface::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScriptDebuggerConsoleWidgetInterface::lineEntered)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QScriptDebuggerConsoleWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebuggerConsoleWidgetInterface.data,
      qt_meta_data_QScriptDebuggerConsoleWidgetInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScriptDebuggerConsoleWidgetInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScriptDebuggerConsoleWidgetInterface.stringdata0))
