...
#include "../../../../git/src/scripttools/debugging/qscriptbreakpointswidget_p.h"
...
struct qt_meta_stringdata_QScriptBreakpointsWidget_t {
    QByteArrayData data[6];
    char stringdata0[109];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScriptBreakpointsWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QScriptBreakpointsWidget_t qt_meta_stringdata_QScriptBreakpointsWidget = {
    {
QT_MOC_LITERAL(0, 0, 24), // "QScriptBreakpointsWidget"
QT_MOC_LITERAL(1, 25, 16), // "_q_newBreakpoint"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 19), // "_q_deleteBreakpoint"
QT_MOC_LITERAL(4, 63, 19), // "_q_onCurrentChanged"
QT_MOC_LITERAL(5, 83, 25) // "_q_onNewBreakpointRequest"

    },
    "QScriptBreakpointsWidget\0_q_newBreakpoint\0"
    "\0_q_deleteBreakpoint\0_q_onCurrentChanged\0"
    "_q_onNewBreakpointRequest"
};
...
const QMetaObject QScriptBreakpointsWidget::staticMetaObject = {
    { &QScriptBreakpointsWidgetInterface::staticMetaObject, qt_meta_stringdata_QScriptBreakpointsWidget.data,
      qt_meta_data_QScriptBreakpointsWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScriptBreakpointsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScriptBreakpointsWidget.stringdata0))
