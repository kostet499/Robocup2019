...
#include "../../../../git/src/scripttools/debugging/qscriptcompletiontaskinterface_p.h"
...
struct qt_meta_stringdata_QScriptCompletionTaskInterface_t {
    QByteArrayData data[3];
    char stringdata0[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScriptCompletionTaskInterface_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QScriptCompletionTaskInterface_t qt_meta_stringdata_QScriptCompletionTaskInterface = {
    {
QT_MOC_LITERAL(0, 0, 30), // "QScriptCompletionTaskInterface"
QT_MOC_LITERAL(1, 31, 8), // "finished"
QT_MOC_LITERAL(2, 40, 0) // ""

    },
    "QScriptCompletionTaskInterface\0finished\0"
    ""
};
...
void QScriptCompletionTaskInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QScriptCompletionTaskInterface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScriptCompletionTaskInterface::finished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QScriptCompletionTaskInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QScriptCompletionTaskInterface.data,
      qt_meta_data_QScriptCompletionTaskInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScriptCompletionTaskInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScriptCompletionTaskInterface.stringdata0))
