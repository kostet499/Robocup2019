...
#include "../../../../git/src/script/bridge/qscriptqobject_p.h"
...
const QMetaObject QScript::QObjectPrototypeObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QScript__QObjectPrototypeObject.data,
      qt_meta_data_QScript__QObjectPrototypeObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScript::QObjectPrototypeObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScript__QObjectPrototypeObject.stringdata0))
        return static_cast<void*>(const_cast< QObjectPrototypeObject*>(this));
