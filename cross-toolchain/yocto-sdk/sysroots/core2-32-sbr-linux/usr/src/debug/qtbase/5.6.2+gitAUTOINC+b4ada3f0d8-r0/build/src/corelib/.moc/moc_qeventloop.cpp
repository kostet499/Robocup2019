...
#include "../../../../git/src/corelib/kernel/qeventloop.h"
...
struct qt_meta_stringdata_QEventLoop_t {
    QByteArrayData data[3];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QEventLoop_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QEventLoop_t qt_meta_stringdata_QEventLoop = {
    {
QT_MOC_LITERAL(0, 0, 10), // "QEventLoop"
...
const QMetaObject QEventLoop::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QEventLoop.data,
      qt_meta_data_QEventLoop,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QEventLoop::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QEventLoop.stringdata0))
