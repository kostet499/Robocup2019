...
#include "../../../../git/src/widgets/graphicsview/qgraphicssceneindex_p.h"
...
struct qt_meta_stringdata_QGraphicsSceneIndex_t {
    QByteArrayData data[4];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGraphicsSceneIndex_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGraphicsSceneIndex_t qt_meta_stringdata_QGraphicsSceneIndex = {
    {
QT_MOC_LITERAL(0, 0, 19), // "QGraphicsSceneIndex"
QT_MOC_LITERAL(1, 20, 15), // "updateSceneRect"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 4) // "rect"

    },
    "QGraphicsSceneIndex\0updateSceneRect\0"
    "\0rect"
};
...
const QMetaObject QGraphicsSceneIndex::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGraphicsSceneIndex.data,
      qt_meta_data_QGraphicsSceneIndex,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGraphicsSceneIndex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGraphicsSceneIndex.stringdata0))
