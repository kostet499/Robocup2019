...
#include "../../../../git/src/widgets/widgets/qtoolbox.h"
...
void QToolBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QToolBox::currentChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QToolBox::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QToolBox.data,
      qt_meta_data_QToolBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
