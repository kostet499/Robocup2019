...
#include "../../../../git/src/widgets/styles/qwindowsstyle_p.h"
...
struct qt_meta_stringdata_QWindowsStyle_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QWindowsStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QWindowsStyle_t qt_meta_stringdata_QWindowsStyle = {
    {
QT_MOC_LITERAL(0, 0, 13) // "QWindowsStyle"
...
const QMetaObject QWindowsStyle::staticMetaObject = {
    { &QCommonStyle::staticMetaObject, qt_meta_stringdata_QWindowsStyle.data,
      qt_meta_data_QWindowsStyle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QWindowsStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QWindowsStyle.stringdata0))
