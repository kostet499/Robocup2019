...
#include "../../../../git/src/corelib/plugin/qfactoryloader_p.h"
...
struct qt_meta_stringdata_QFactoryLoader_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QFactoryLoader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QFactoryLoader_t qt_meta_stringdata_QFactoryLoader = {
    {
QT_MOC_LITERAL(0, 0, 14) // "QFactoryLoader"
...
const QMetaObject QFactoryLoader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QFactoryLoader.data,
      qt_meta_data_QFactoryLoader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QFactoryLoader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QFactoryLoader.stringdata0))
