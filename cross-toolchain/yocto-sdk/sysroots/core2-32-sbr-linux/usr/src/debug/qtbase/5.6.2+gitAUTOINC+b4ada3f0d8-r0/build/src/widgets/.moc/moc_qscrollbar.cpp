...
#include "../../../../git/src/widgets/widgets/qscrollbar.h"
...
struct qt_meta_stringdata_QScrollBar_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScrollBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QScrollBar_t qt_meta_stringdata_QScrollBar = {
    {
QT_MOC_LITERAL(0, 0, 10) // "QScrollBar"
...
const QMetaObject QScrollBar::staticMetaObject = {
    { &QAbstractSlider::staticMetaObject, qt_meta_stringdata_QScrollBar.data,
      qt_meta_data_QScrollBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScrollBar.stringdata0))
