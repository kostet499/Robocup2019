...
#include "../../../../git/src/corelib/statemachine/qabstractstate.h"
...
void QAbstractState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QAbstractState::*_t)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractState::entered)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QAbstractState::*_t)(QPrivateSignal);
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractState::exited)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QAbstractState::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QAbstractState::activeChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QAbstractState::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractState.data,
      qt_meta_data_QAbstractState,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void QAbstractState::entered(QPrivateSignal)
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void QAbstractState::exited(QPrivateSignal)
{
