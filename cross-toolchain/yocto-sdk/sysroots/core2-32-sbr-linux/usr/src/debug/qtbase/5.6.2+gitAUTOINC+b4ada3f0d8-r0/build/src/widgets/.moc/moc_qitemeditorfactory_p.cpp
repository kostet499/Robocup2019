...
#include "../../../../git/src/widgets/itemviews/qitemeditorfactory_p.h"
...
struct qt_meta_stringdata_QExpandingLineEdit_t {
    QByteArrayData data[3];
    char stringdata0[37];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QExpandingLineEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QExpandingLineEdit_t qt_meta_stringdata_QExpandingLineEdit = {
    {
QT_MOC_LITERAL(0, 0, 18), // "QExpandingLineEdit"
QT_MOC_LITERAL(1, 19, 16), // "resizeToContents"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "QExpandingLineEdit\0resizeToContents\0"
    ""
};
...
const QMetaObject QExpandingLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_QExpandingLineEdit.data,
      qt_meta_data_QExpandingLineEdit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QExpandingLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QExpandingLineEdit.stringdata0))
