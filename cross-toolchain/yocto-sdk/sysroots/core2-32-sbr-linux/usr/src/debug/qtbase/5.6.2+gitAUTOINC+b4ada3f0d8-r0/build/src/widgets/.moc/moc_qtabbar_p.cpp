...
#include "../../../../git/src/widgets/widgets/qtabbar_p.h"
...
struct qt_meta_stringdata_CloseButton_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CloseButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CloseButton_t qt_meta_stringdata_CloseButton = {
    {
QT_MOC_LITERAL(0, 0, 11) // "CloseButton"
...
const QMetaObject CloseButton::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_CloseButton.data,
      qt_meta_data_CloseButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CloseButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CloseButton.stringdata0))
