...
#include "../../../../git/src/gui/kernel/qpaintdevicewindow.h"
...
void QPaintDeviceWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QPaintDeviceWindow *_t = static_cast<QPaintDeviceWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QPaintDeviceWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_QPaintDeviceWindow.data,
      qt_meta_data_QPaintDeviceWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPaintDeviceWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPaintDeviceWindow.stringdata0))
        return static_cast<void*>(const_cast< QPaintDeviceWindow*>(this));
    if (!strcmp(_clname, "QPaintDevice"))
        return static_cast< QPaintDevice*>(const_cast< QPaintDeviceWindow*>(this));
