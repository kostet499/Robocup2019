...
#include "../../../../git/src/widgets/statemachine/qbasickeyeventtransition_p.h"
...
struct qt_meta_stringdata_QBasicKeyEventTransition_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QBasicKeyEventTransition_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QBasicKeyEventTransition_t qt_meta_stringdata_QBasicKeyEventTransition = {
    {
QT_MOC_LITERAL(0, 0, 24) // "QBasicKeyEventTransition"
...
const QMetaObject QBasicKeyEventTransition::staticMetaObject = {
    { &QAbstractTransition::staticMetaObject, qt_meta_stringdata_QBasicKeyEventTransition.data,
      qt_meta_data_QBasicKeyEventTransition,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QBasicKeyEventTransition::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QBasicKeyEventTransition.stringdata0))
