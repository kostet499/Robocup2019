...
#include "../../../../git/src/corelib/kernel/qcoreevent.h"
...
struct qt_meta_stringdata_QEvent_t {
    QByteArrayData data[172];
    char stringdata0[2561];
};
...
QT_MOC_LITERAL(170, 2548, 4), // "User"
QT_MOC_LITERAL(171, 2553, 7) // "MaxUser"
...
static const uint qt_meta_data_QEvent[] = {
 ...
 // enum data: key, value
     ...
     170, uint(QEvent::User),
     171, uint(QEvent::MaxUser),
