...
#include "../../../../git/src/corelib/kernel/qeventdispatcher_unix_p.h"
...
const QMetaObject QEventDispatcherUNIX::staticMetaObject = {
    { &QAbstractEventDispatcher::staticMetaObject, qt_meta_stringdata_QEventDispatcherUNIX.data,
      qt_meta_data_QEventDispatcherUNIX,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QEventDispatcherUNIX::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QEventDispatcherUNIX.stringdata0))
        return static_cast<void*>(const_cast< QEventDispatcherUNIX*>(this));
