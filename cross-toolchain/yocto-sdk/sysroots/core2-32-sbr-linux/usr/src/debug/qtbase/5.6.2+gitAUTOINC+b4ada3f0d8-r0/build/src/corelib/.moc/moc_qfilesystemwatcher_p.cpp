...
#include "../../../../git/src/corelib/io/qfilesystemwatcher_p.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QFileSystemWatcherEngine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QFileSystemWatcherEngine_t qt_meta_stringdata_QFileSystemWatcherEngine = {
    {
QT_MOC_LITERAL(0, 0, 24), // "QFileSystemWatcherEngine"
QT_MOC_LITERAL(1, 25, 11), // "fileChanged"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 4), // "path"
QT_MOC_LITERAL(4, 43, 7), // "removed"
QT_MOC_LITERAL(5, 51, 16) // "directoryChanged"
...
const QMetaObject QFileSystemWatcherEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QFileSystemWatcherEngine.data,
      qt_meta_data_QFileSystemWatcherEngine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QFileSystemWatcherEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QFileSystemWatcherEngine.stringdata0))
