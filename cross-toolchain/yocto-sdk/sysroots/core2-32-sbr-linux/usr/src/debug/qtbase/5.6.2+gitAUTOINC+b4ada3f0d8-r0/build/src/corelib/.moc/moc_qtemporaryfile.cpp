...
#include "../../../../git/src/corelib/io/qtemporaryfile.h"
...
struct qt_meta_stringdata_QTemporaryFile_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QTemporaryFile_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QTemporaryFile_t qt_meta_stringdata_QTemporaryFile = {
    {
QT_MOC_LITERAL(0, 0, 14) // "QTemporaryFile"
...
const QMetaObject QTemporaryFile::staticMetaObject = {
    { &QFile::staticMetaObject, qt_meta_stringdata_QTemporaryFile.data,
      qt_meta_data_QTemporaryFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QTemporaryFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QTemporaryFile.stringdata0))
