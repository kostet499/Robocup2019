...
#include "../../../../git/src/gui/image/qimageiohandler.h"
...
struct qt_meta_stringdata_QImageIOPlugin_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QImageIOPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QImageIOPlugin_t qt_meta_stringdata_QImageIOPlugin = {
    {
QT_MOC_LITERAL(0, 0, 14) // "QImageIOPlugin"
...
const QMetaObject QImageIOPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QImageIOPlugin.data,
      qt_meta_data_QImageIOPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QImageIOPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QImageIOPlugin.stringdata0))
