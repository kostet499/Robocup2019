...
#include "../../../../git/src/widgets/styles/qcommonstyle.h"
...
struct qt_meta_stringdata_QCommonStyle_t {
    QByteArrayData data[3];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QCommonStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QCommonStyle_t qt_meta_stringdata_QCommonStyle = {
    {
QT_MOC_LITERAL(0, 0, 12), // "QCommonStyle"
QT_MOC_LITERAL(1, 13, 18), // "_q_removeAnimation"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "QCommonStyle\0_q_removeAnimation\0"
};
...
void QCommonStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->d_func()->_q_removeAnimation(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject QCommonStyle::staticMetaObject = {
    { &QStyle::staticMetaObject, qt_meta_stringdata_QCommonStyle.data,
      qt_meta_data_QCommonStyle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QCommonStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QCommonStyle.stringdata0))
