...
#include "../../../../git/src/sql/models/qsqlquerymodel.h"
...
struct qt_meta_stringdata_QSqlQueryModel_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QSqlQueryModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSqlQueryModel_t qt_meta_stringdata_QSqlQueryModel = {
    {
QT_MOC_LITERAL(0, 0, 14) // "QSqlQueryModel"
...
const QMetaObject QSqlQueryModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_QSqlQueryModel.data,
      qt_meta_data_QSqlQueryModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QSqlQueryModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSqlQueryModel.stringdata0))
