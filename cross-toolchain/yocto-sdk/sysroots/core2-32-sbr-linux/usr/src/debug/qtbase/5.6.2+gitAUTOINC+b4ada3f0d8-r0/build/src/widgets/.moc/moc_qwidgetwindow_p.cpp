...
#include "../../../../git/src/widgets/kernel/qwidgetwindow_p.h"
...
void QWidgetWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QWidgetWindow *_t = static_cast<QWidgetWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QWidgetWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_QWidgetWindow.data,
      qt_meta_data_QWidgetWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QWidgetWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QWidgetWindow.stringdata0))
        return static_cast<void*>(const_cast< QWidgetWindow*>(this));
