...
#include "../../../../git/src/widgets/itemviews/qcolumnviewgrip_p.h"
...
void QColumnViewGrip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QColumnViewGrip::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QColumnViewGrip::gripMoved)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QColumnViewGrip::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QColumnViewGrip.data,
      qt_meta_data_QColumnViewGrip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
