...
public:
    ...
    void setupUi(QWidget *QPrintSettingsOutput)
    {
        ...
        QPrintSettingsOutput->resize(426, 187);
        ...
        printCurrentPage->setObjectName(QStringLiteral("printCurrentPage"));
        ...
        pageSetLabel->setObjectName(QStringLiteral("pageSetLabel"));
        pageSetLabel->setVisible(false);

        _5->addWidget(pageSetLabel);

        pageSetCombo = new QComboBox(gbPrintRange);
        pageSetCombo->setObjectName(QStringLiteral("pageSetCombo"));
    ...
    void retranslateUi(QWidget *QPrintSettingsOutput)
    {
        ...
        printCurrentPage->setText(QApplication::translate("QPrintSettingsOutput", "Current Page", 0));
        printSelection->setText(QApplication::translate("QPrintSettingsOutput", "Selection", 0));
        pageSetLabel->setText(QApplication::translate("QPrintSettingsOutput", "Page Set:", 0));
