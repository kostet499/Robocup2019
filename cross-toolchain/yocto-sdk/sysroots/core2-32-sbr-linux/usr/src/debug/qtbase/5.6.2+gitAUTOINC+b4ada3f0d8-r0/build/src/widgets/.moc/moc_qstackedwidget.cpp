...
#include "../../../../git/src/widgets/widgets/qstackedwidget.h"
...
struct qt_meta_stringdata_QStackedWidget_t {
    QByteArrayData data[11];
    char stringdata0[114];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QStackedWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QStackedWidget_t qt_meta_stringdata_QStackedWidget = {
    {
QT_MOC_LITERAL(0, 0, 14), // "QStackedWidget"
QT_MOC_LITERAL(1, 15, 14), // "currentChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 13), // "widgetRemoved"
QT_MOC_LITERAL(4, 45, 5), // "index"
QT_MOC_LITERAL(5, 51, 15), // "setCurrentIndex"
QT_MOC_LITERAL(6, 67, 16), // "setCurrentWidget"
QT_MOC_LITERAL(7, 84, 8), // "QWidget*"
QT_MOC_LITERAL(8, 93, 1), // "w"
QT_MOC_LITERAL(9, 95, 12), // "currentIndex"
QT_MOC_LITERAL(10, 108, 5) // "count"

    },
    "QStackedWidget\0currentChanged\0\0"
    "widgetRemoved\0index\0setCurrentIndex\0"
...
void QStackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QStackedWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QStackedWidget::currentChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QStackedWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QStackedWidget::widgetRemoved)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QStackedWidget::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QStackedWidget.data,
      qt_meta_data_QStackedWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QStackedWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QStackedWidget.stringdata0))
