...
#include "../../../../git/src/gui/kernel/qplatformgraphicsbuffer.h"
...
QT_MOC_LITERAL(4, 46, 19) // "previousAccessTypes"
    ...
    "AccessTypes\0previousAccessTypes"
};
...
void QPlatformGraphicsBuffer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QPlatformGraphicsBuffer *_t = static_cast<QPlatformGraphicsBuffer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QPlatformGraphicsBuffer::*_t)(AccessTypes );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QPlatformGraphicsBuffer::unlocked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QPlatformGraphicsBuffer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPlatformGraphicsBuffer.data,
      qt_meta_data_QPlatformGraphicsBuffer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPlatformGraphicsBuffer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformGraphicsBuffer.stringdata0))
        return static_cast<void*>(const_cast< QPlatformGraphicsBuffer*>(this));
