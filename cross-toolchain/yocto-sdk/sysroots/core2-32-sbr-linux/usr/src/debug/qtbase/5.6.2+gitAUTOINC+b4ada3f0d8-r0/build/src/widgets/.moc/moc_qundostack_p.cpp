...
#include "../../../../git/src/widgets/util/qundostack_p.h"
...
struct qt_meta_stringdata_QUndoAction_t {
    QByteArrayData data[4];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QUndoAction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QUndoAction_t qt_meta_stringdata_QUndoAction = {
    {
QT_MOC_LITERAL(0, 0, 11), // "QUndoAction"
QT_MOC_LITERAL(1, 12, 15), // "setPrefixedText"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4) // "text"

    },
    "QUndoAction\0setPrefixedText\0\0text"
};
...
const QMetaObject QUndoAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_QUndoAction.data,
      qt_meta_data_QUndoAction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QUndoAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QUndoAction.stringdata0))
