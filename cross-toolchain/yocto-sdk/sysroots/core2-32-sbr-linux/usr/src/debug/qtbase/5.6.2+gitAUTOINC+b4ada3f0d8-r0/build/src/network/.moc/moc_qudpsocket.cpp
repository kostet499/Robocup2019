...
#include "../../../../git/src/network/socket/qudpsocket.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QUdpSocket_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QUdpSocket_t qt_meta_stringdata_QUdpSocket = {
    {
QT_MOC_LITERAL(0, 0, 10) // "QUdpSocket"
...
const QMetaObject QUdpSocket::staticMetaObject = {
    { &QAbstractSocket::staticMetaObject, qt_meta_stringdata_QUdpSocket.data,
      qt_meta_data_QUdpSocket,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QUdpSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QUdpSocket.stringdata0))
