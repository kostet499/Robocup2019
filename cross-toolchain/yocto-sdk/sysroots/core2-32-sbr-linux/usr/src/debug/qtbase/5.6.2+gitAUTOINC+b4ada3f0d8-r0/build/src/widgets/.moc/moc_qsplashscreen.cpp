...
#include "../../../../git/src/widgets/widgets/qsplashscreen.h"
...
struct qt_meta_stringdata_QSplashScreen_t {
    QByteArrayData data[8];
    char stringdata0[79];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QSplashScreen_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSplashScreen_t qt_meta_stringdata_QSplashScreen = {
    {
QT_MOC_LITERAL(0, 0, 13), // "QSplashScreen"
QT_MOC_LITERAL(1, 14, 14), // "messageChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "message"
QT_MOC_LITERAL(4, 38, 11), // "showMessage"
QT_MOC_LITERAL(5, 50, 9), // "alignment"
QT_MOC_LITERAL(6, 60, 5), // "color"
QT_MOC_LITERAL(7, 66, 12) // "clearMessage"

    },
    "QSplashScreen\0messageChanged\0\0message\0"
    "showMessage\0alignment\0color\0clearMessage"
};
...
void QSplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QSplashScreen::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSplashScreen::messageChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QSplashScreen::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QSplashScreen.data,
      qt_meta_data_QSplashScreen,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QSplashScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSplashScreen.stringdata0))
