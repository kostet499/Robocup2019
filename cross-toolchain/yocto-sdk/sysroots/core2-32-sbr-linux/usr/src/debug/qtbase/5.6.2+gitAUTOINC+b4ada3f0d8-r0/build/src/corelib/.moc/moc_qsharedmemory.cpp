...
#include "../../../../git/src/corelib/kernel/qsharedmemory.h"
...
struct qt_meta_stringdata_QSharedMemory_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QSharedMemory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QSharedMemory_t qt_meta_stringdata_QSharedMemory = {
    {
QT_MOC_LITERAL(0, 0, 13) // "QSharedMemory"
...
const QMetaObject QSharedMemory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QSharedMemory.data,
      qt_meta_data_QSharedMemory,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QSharedMemory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSharedMemory.stringdata0))
