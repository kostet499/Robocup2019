...
#include "../../../../git/src/corelib/io/qfilesystemwatcher_inotify_p.h"
...
struct qt_meta_stringdata_QInotifyFileSystemWatcherEngine_t {
    QByteArrayData data[3];
    char stringdata0[49];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QInotifyFileSystemWatcherEngine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QInotifyFileSystemWatcherEngine_t qt_meta_stringdata_QInotifyFileSystemWatcherEngine = {
    {
QT_MOC_LITERAL(0, 0, 31), // "QInotifyFileSystemWatcherEngine"
QT_MOC_LITERAL(1, 32, 15), // "readFromInotify"
QT_MOC_LITERAL(2, 48, 0) // ""

    },
    "QInotifyFileSystemWatcherEngine\0"
    "readFromInotify\0"
};
...
const QMetaObject QInotifyFileSystemWatcherEngine::staticMetaObject = {
    { &QFileSystemWatcherEngine::staticMetaObject, qt_meta_stringdata_QInotifyFileSystemWatcherEngine.data,
      qt_meta_data_QInotifyFileSystemWatcherEngine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QInotifyFileSystemWatcherEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QInotifyFileSystemWatcherEngine.stringdata0))
