...
#include "../../../../git/src/gui/text/qtextimagehandler_p.h"
...
struct qt_meta_stringdata_QTextImageHandler_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QTextImageHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QTextImageHandler_t qt_meta_stringdata_QTextImageHandler = {
    {
QT_MOC_LITERAL(0, 0, 17) // "QTextImageHandler"
...
const QMetaObject QTextImageHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTextImageHandler.data,
      qt_meta_data_QTextImageHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QTextImageHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QTextImageHandler.stringdata0))
