...
#include "../../../../../../git/src/plugins/bearer/generic/qgenericengine.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGenericEngine_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGenericEngine_t qt_meta_stringdata_QGenericEngine = {
    {
QT_MOC_LITERAL(0, 0, 14), // "QGenericEngine"
QT_MOC_LITERAL(1, 15, 15), // "doRequestUpdate"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "initialize"
QT_MOC_LITERAL(4, 43, 13) // "requestUpdate"
...
const QMetaObject QGenericEngine::staticMetaObject = {
    { &QBearerEngineImpl::staticMetaObject, qt_meta_stringdata_QGenericEngine.data,
      qt_meta_data_QGenericEngine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGenericEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGenericEngine.stringdata0))
