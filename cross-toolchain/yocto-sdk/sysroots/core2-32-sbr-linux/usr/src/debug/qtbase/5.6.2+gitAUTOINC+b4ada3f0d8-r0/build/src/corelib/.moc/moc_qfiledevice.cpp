...
#include "../../../../git/src/corelib/io/qfiledevice.h"
...
const QMetaObject QFileDevice::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QFileDevice.data,
      qt_meta_data_QFileDevice,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QFileDevice::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QFileDevice.stringdata0))
        return static_cast<void*>(const_cast< QFileDevice*>(this));
