...
#include "../../../../git/src/widgets/statemachine/qmouseeventtransition.h"
...
void QMouseEventTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QMouseEventTransition *_t = static_cast<QMouseEventTransition *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject QMouseEventTransition::staticMetaObject = {
    { &QEventTransition::staticMetaObject, qt_meta_stringdata_QMouseEventTransition.data,
      qt_meta_data_QMouseEventTransition,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
