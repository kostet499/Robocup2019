...
#include "../../../../git/src/gui/image/qpictureformatplugin.h"
...
struct qt_meta_stringdata_QPictureFormatPlugin_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPictureFormatPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QPictureFormatPlugin_t qt_meta_stringdata_QPictureFormatPlugin = {
    {
QT_MOC_LITERAL(0, 0, 20) // "QPictureFormatPlugin"
...
const QMetaObject QPictureFormatPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPictureFormatPlugin.data,
      qt_meta_data_QPictureFormatPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPictureFormatPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPictureFormatPlugin.stringdata0))
