...
#include "../../../../git/src/gui/image/qiconengineplugin.h"
...
struct qt_meta_stringdata_QIconEnginePlugin_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QIconEnginePlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QIconEnginePlugin_t qt_meta_stringdata_QIconEnginePlugin = {
    {
QT_MOC_LITERAL(0, 0, 17) // "QIconEnginePlugin"
...
const QMetaObject QIconEnginePlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QIconEnginePlugin.data,
      qt_meta_data_QIconEnginePlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QIconEnginePlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QIconEnginePlugin.stringdata0))
