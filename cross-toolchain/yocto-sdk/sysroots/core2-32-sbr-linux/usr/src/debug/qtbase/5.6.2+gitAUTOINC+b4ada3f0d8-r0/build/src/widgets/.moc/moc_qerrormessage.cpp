...
#include "../../../../git/src/widgets/dialogs/qerrormessage.h"
...
struct qt_meta_stringdata_QErrorMessage_t {
    QByteArrayData data[5];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QErrorMessage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QErrorMessage_t qt_meta_stringdata_QErrorMessage = {
    {
QT_MOC_LITERAL(0, 0, 13), // "QErrorMessage"
...
QT_MOC_LITERAL(4, 35, 4) // "type"
    ...
    "QErrorMessage\0showMessage\0\0message\0"
    "type"
};
...
const QMetaObject QErrorMessage::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QErrorMessage.data,
      qt_meta_data_QErrorMessage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QErrorMessage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QErrorMessage.stringdata0))
