...
#include "../../../../git/src/printsupport/dialogs/qabstractprintdialog.h"
...
const QMetaObject QAbstractPrintDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QAbstractPrintDialog.data,
      qt_meta_data_QAbstractPrintDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QAbstractPrintDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractPrintDialog.stringdata0))
        return static_cast<void*>(const_cast< QAbstractPrintDialog*>(this));
