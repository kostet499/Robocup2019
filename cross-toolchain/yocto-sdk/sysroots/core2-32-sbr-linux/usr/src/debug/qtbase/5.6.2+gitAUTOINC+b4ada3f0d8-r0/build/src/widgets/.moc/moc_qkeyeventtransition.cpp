...
#include "../../../../git/src/widgets/statemachine/qkeyeventtransition.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QKeyEventTransition_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QKeyEventTransition_t qt_meta_stringdata_QKeyEventTransition = {
    {
QT_MOC_LITERAL(0, 0, 19), // "QKeyEventTransition"
QT_MOC_LITERAL(1, 20, 3), // "key"
QT_MOC_LITERAL(2, 24, 12), // "modifierMask"
QT_MOC_LITERAL(3, 37, 21) // "Qt::KeyboardModifiers"
...
void QKeyEventTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        QKeyEventTransition *_t = static_cast<QKeyEventTransition *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setKey(*reinterpret_cast< int*>(_v)); break;
...
const QMetaObject QKeyEventTransition::staticMetaObject = {
    { &QEventTransition::staticMetaObject, qt_meta_stringdata_QKeyEventTransition.data,
      qt_meta_data_QKeyEventTransition,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QKeyEventTransition::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QKeyEventTransition.stringdata0))
