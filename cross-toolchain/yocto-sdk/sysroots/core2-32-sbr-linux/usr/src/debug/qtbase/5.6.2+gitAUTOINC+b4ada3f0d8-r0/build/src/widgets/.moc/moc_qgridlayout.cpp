...
#include "../../../../git/src/widgets/kernel/qgridlayout.h"
...
struct qt_meta_stringdata_QGridLayout_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGridLayout_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGridLayout_t qt_meta_stringdata_QGridLayout = {
    {
QT_MOC_LITERAL(0, 0, 11) // "QGridLayout"
...
const QMetaObject QGridLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QGridLayout.data,
      qt_meta_data_QGridLayout,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QGridLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGridLayout.stringdata0))
