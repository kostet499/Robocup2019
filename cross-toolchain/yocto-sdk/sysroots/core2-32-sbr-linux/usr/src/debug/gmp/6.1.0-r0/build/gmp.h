...
#define __GMP_CC "i686-sbr-linux-gcc  -m32 -march=core2 -mtune=core2 -msse3 -mfpmath=sse --sysroot=/home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/sysroots/ald-atom"
#define __GMP_CFLAGS "-m32 -O2 -pedantic -fomit-frame-pointer -mtune=pentiumpro -march=pentiumpro  -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/work/core2-32-sbr-linux/gmp/6.1.0-r0=/usr/src/debug/gmp/6.1.0-r0 -fdebug-prefix-map=/home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/sysroots/x86_64-linux= -fdebug-prefix-map=/home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/sysroots/ald-atom= "
