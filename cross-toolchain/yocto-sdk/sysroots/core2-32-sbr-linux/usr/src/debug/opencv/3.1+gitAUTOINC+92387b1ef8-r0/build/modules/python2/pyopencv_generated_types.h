...
static PyMethodDef pyopencv_VideoCapture_methods[] =
{
    ...
    {"open", (PyCFunction)pyopencv_cv_VideoCapture_open, METH_VARARGS | METH_KEYWORDS, "open(filename) -> retval  or  open(index) -> retval  or  open(filename, apiPreference) -> retval"},
