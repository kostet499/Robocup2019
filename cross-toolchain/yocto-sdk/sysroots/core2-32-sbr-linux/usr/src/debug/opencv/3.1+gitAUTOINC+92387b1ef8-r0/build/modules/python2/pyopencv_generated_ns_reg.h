...
static PyMethodDef methods_face[] = {
    {"MinDistancePredictCollector", (PyCFunction)pyopencv_cv_face_face_MinDistancePredictCollector_MinDistancePredictCollector, METH_VARARGS | METH_KEYWORDS, "MinDistancePredictCollector([, threshhold]) -> <face_MinDistancePredictCollector object>"},
    {"MinDistancePredictCollector_create", (PyCFunction)pyopencv_cv_face_MinDistancePredictCollector_create, METH_VARARGS | METH_KEYWORDS, "MinDistancePredictCollector_create([, threshold]) -> retval"},
...
static ConstDef consts_ppf_match_3d[] = {
    {"ICP_ICP_SAMPLING_TYPE_GELFAND", cv::ppf_match_3d::ICP::ICP_SAMPLING_TYPE_GELFAND},
    {"ICP_ICP_SAMPLING_TYPE_UNIFORM", cv::ppf_match_3d::ICP::ICP_SAMPLING_TYPE_UNIFORM},
    {NULL, 0}
};
...
static PyMethodDef methods_xphoto[] = {
    {"autowbGrayworld", (PyCFunction)pyopencv_cv_xphoto_autowbGrayworld, METH_VARARGS | METH_KEYWORDS, "autowbGrayworld(src[, dst[, thresh]]) -> dst"},
    {"balanceWhite", (PyCFunction)pyopencv_cv_xphoto_balanceWhite, METH_VARARGS | METH_KEYWORDS, "balanceWhite(src, dst, algorithmType[, inputMin[, inputMax[, outputMin[, outputMax]]]]) -> None"},
...
static ConstDef consts_xphoto[] = {
    ...
    {"WHITE_BALANCE_GRAYWORLD", cv::xphoto::WHITE_BALANCE_GRAYWORLD},
    {"WHITE_BALANCE_SIMPLE", cv::xphoto::WHITE_BALANCE_SIMPLE},
    {NULL, 0}
};
