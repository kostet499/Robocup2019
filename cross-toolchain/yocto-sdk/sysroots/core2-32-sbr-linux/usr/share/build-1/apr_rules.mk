...
#
apr_builddir=/usr/share/build-1
apr_builders=/usr/share/build-1
top_builddir=/usr/share/build-1

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.5.2

CC=i686-sbr-linux-gcc  -m32 -march=core2 -mtune=core2 -msse3 -mfpmath=sse --sysroot=
RM=rm
AWK=gawk
SHELL=/bin/bash
LIBTOOL=$(apr_builddir)/i686-sbr-linux-libtool

# compilation and linking flags that are supposed to be set only by the user.
# configure adds to them for tests, but we restore them at the end.
#
CFLAGS= -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/work/core2-32-sbr-linux/apr/1.5.2-r0=/usr/src/debug/apr/1.5.2-r0 -fdebug-prefix-map=/home/opennao/jenkins/workspace/yocto-rootfs/build/tmp/sysroots/x86_64-linux= -fdebug-prefix-map== 
CPPFLAGS=
...
EXTRA_LDFLAGS=
EXTRA_LIBS=-luuid -lrt -lcrypt  -ldl
EXTRA_INCLUDES=
