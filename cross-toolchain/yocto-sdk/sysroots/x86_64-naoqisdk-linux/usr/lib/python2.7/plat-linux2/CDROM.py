# Generated by h2py from /home/vlad/studies/Robocup2019/ctc-linux64-atom-2.8.2.15/yocto-sdk/sysroots/x86_64-naoqisdk-linux/usr/include/linux/cdrom.h

# Included from linux/types.h

# Included from asm/types.h

# Included from asm-generic/types.h

# Included from asm-generic/int-ll64.h

# Included from asm/bitsperlong.h
__BITS_PER_LONG = 64
__BITS_PER_LONG = 32

# Included from asm-generic/bitsperlong.h
__BITS_PER_LONG = 32
...
# Included from asm/posix_types_32.h

# Included from asm-generic/posix_types.h

# Included from asm/posix_types_x32.h

# Included from asm/posix_types_64.h
...
# Included from linux/swab.h

# Included from asm/swab.h
def __swab16(x): return \

def __swab32(x): return \

def __swab64(x): return \

def __swahw32(x): return \

def __swahb32(x): return \

def __constant_ntohl(x): return ___constant_swab32((__be32)(x))

def __constant_ntohs(x): return ___constant_swab16((__be16)(x))

def __constant_cpu_to_le64(x): return ((__le64)(__u64)(x))

def __constant_le64_to_cpu(x): return ((__u64)(__le64)(x))

def __constant_cpu_to_le32(x): return ((__le32)(__u32)(x))

def __constant_le32_to_cpu(x): return ((__u32)(__le32)(x))

def __constant_cpu_to_le16(x): return ((__le16)(__u16)(x))

def __constant_le16_to_cpu(x): return ((__u16)(__le16)(x))

def __constant_be64_to_cpu(x): return ___constant_swab64((__u64)(__be64)(x))

def __constant_be32_to_cpu(x): return ___constant_swab32((__u32)(__be32)(x))

def __constant_be16_to_cpu(x): return ___constant_swab16((__u16)(__be16)(x))

def __cpu_to_le64(x): return ((__le64)(__u64)(x))

def __le64_to_cpu(x): return ((__u64)(__le64)(x))

def __cpu_to_le32(x): return ((__le32)(__u32)(x))

def __le32_to_cpu(x): return ((__u32)(__le32)(x))

def __cpu_to_le16(x): return ((__le16)(__u16)(x))

def __le16_to_cpu(x): return ((__u16)(__le16)(x))

def __be64_to_cpu(x): return __swab64((__u64)(__be64)(x))

def __be32_to_cpu(x): return __swab32((__u32)(__be32)(x))

def __be16_to_cpu(x): return __swab16((__u16)(__be16)(x))
