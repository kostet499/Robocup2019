...
enum opt_code
{
  ...
  OPT_ffile_prefix_map_ = 649,               /* -ffile-prefix-map= */
  OPT_ffilelist_file = 650,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 651,               /* -ffinite-math-only */
  OPT_ffixed_ = 652,                         /* -ffixed- */
  OPT_ffixed_form = 653,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 654,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 655,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 656,                    /* -ffloat-store */
  OPT_ffor_scope = 657,                      /* -ffor-scope */
  /* OPT_fforce_addr = 658, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 659,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 660,              /* -fforward-propagate */
  OPT_ffp_contract_ = 661,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 662,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 663,                      /* -ffpe-trap= */
  OPT_ffree_form = 664,                      /* -ffree-form */
  OPT_ffree_line_length_ = 665,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 666,          /* -ffree-line-length-none */
  OPT_ffreestanding = 667,                   /* -ffreestanding */
  OPT_ffriend_injection = 668,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 669,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 670,                   /* -ffunction-cse */
  OPT_ffunction_sections = 671,              /* -ffunction-sections */
  OPT_fgcse = 672,                           /* -fgcse */
  OPT_fgcse_after_reload = 673,              /* -fgcse-after-reload */
  OPT_fgcse_las = 674,                       /* -fgcse-las */
  OPT_fgcse_lm = 675,                        /* -fgcse-lm */
  OPT_fgcse_sm = 676,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 677,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 678,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 679,                         /* -fgnu-tm */
  OPT_fgnu_unique = 680,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 681,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 682,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 683,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 684,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 685,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 686,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 687,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 688,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 689,                       /* -fgraphite */
  OPT_fgraphite_identity = 690,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 691,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 692, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 693, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 694,           /* -fhash-synchronization */
  /* OPT_fhelp = 695, */                     /* -fhelp */
  /* OPT_fhelp_ = 696, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 697,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 698, */                /* -fhonor-std */
  OPT_fhosted = 699,                         /* -fhosted */
  /* OPT_fhuge_objects = 700, */             /* -fhuge-objects */
  OPT_fident = 701,                          /* -fident */
  OPT_fif_conversion = 702,                  /* -fif-conversion */
  OPT_fif_conversion2 = 703,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 704,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 705,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 706,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 707,             /* -fimplicit-templates */
  OPT_findirect_classes = 708,               /* -findirect-classes */
  OPT_findirect_dispatch = 709,              /* -findirect-dispatch */
  OPT_findirect_inlining = 710,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 711,         /* -finhibit-size-directive */
  OPT_finit_character_ = 712,                /* -finit-character= */
  OPT_finit_integer_ = 713,                  /* -finit-integer= */
  OPT_finit_local_zero = 714,                /* -finit-local-zero */
  OPT_finit_logical_ = 715,                  /* -finit-logical= */
  OPT_finit_real_ = 716,                     /* -finit-real= */
  OPT_finline = 717,                         /* -finline */
  OPT_finline_atomics = 718,                 /* -finline-atomics */
  OPT_finline_functions = 719,               /* -finline-functions */
  OPT_finline_functions_called_once = 720,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 721, */            /* -finline-limit- */
  OPT_finline_limit_ = 722,                  /* -finline-limit= */
  OPT_finline_small_functions = 723,         /* -finline-small-functions */
  OPT_finput_charset_ = 724,                 /* -finput-charset= */
  OPT_finstrument_functions = 725,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 726,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 727,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 728,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 729,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 730,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 731,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 732,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 733,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 734,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 735,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 736,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 737, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 738,                    /* -fipa-profile */
  OPT_fipa_pta = 739,                        /* -fipa-pta */
  OPT_fipa_pure_const = 740,                 /* -fipa-pure-const */
  OPT_fipa_ra = 741,                         /* -fipa-ra */
  ...
  OPT_fivar_visibility_ = 754,               /* -fivar-visibility= */
  OPT_fivopts = 755,                         /* -fivopts */
  OPT_fjni = 756,                            /* -fjni */
  OPT_fjump_tables = 757,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 758,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 759,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 760,             /* -fkeep-static-consts */
  ...
  OPT_fmain_ = 785,                          /* -fmain= */
  OPT_fmath_errno = 786,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 787,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 788,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 789,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 790,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 791,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 792,                     /* -fmem-report */
  OPT_fmem_report_wpa = 793,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 794,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 795,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 796,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 797,                /* -fmessage-length= */
  OPT_fmodule_private = 798,                 /* -fmodule-private */
  OPT_fmodulo_sched = 799,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 800,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 801,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 802,                  /* -fms-extensions */
  /* OPT_fmudflap = 803, */                  /* -fmudflap */
  /* OPT_fmudflapir = 804, */                /* -fmudflapir */
  /* OPT_fmudflapth = 805, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 806, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 807, */                  /* -fnew-abi */
  OPT_fnext_runtime = 808,                   /* -fnext-runtime */
  OPT_fnil_receivers = 809,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 810, */       /* -fno-vect-cost-model */
  ...
  OPT_fopenmp = 827,                         /* -fopenmp */
  OPT_fopenmp_simd = 828,                    /* -fopenmp-simd */
  OPT_foperator_names = 829,                 /* -foperator-names */
  OPT_fopt_info = 830,                       /* -fopt-info */
  OPT_fopt_info_ = 831,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 832, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 833,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 834,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 835,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 836, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 837,              /* -foutput-class-dir= */
  OPT_fpack_derived = 838,                   /* -fpack-derived */
  OPT_fpack_struct = 839,                    /* -fpack-struct */
  OPT_fpack_struct_ = 840,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 841,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 842,              /* -fpcc-struct-return */
  OPT_fpch_deps = 843,                       /* -fpch-deps */
  OPT_fpch_preprocess = 844,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 845,                     /* -fpeel-loops */
  OPT_fpeephole = 846,                       /* -fpeephole */
  OPT_fpeephole2 = 847,                      /* -fpeephole2 */
  OPT_fpermissive = 848,                     /* -fpermissive */
  OPT_fpic = 849,                            /* -fpic */
  OPT_fpie = 850,                            /* -fpie */
  OPT_fplan9_extensions = 851,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 852,                    /* -fplugin-arg- */
  OPT_fplugin_ = 853,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 854,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 855,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 856,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 857,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 858,                   /* -fpreprocessed */
  OPT_fpretty_templates = 859,               /* -fpretty-templates */
  OPT_fprofile = 860,                        /* -fprofile */
  OPT_fprofile_arcs = 861,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 862,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 863,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 864,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 865,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 866,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 867,                 /* -fprofile-report */
  OPT_fprofile_use = 868,                    /* -fprofile-use */
  OPT_fprofile_use_ = 869,                   /* -fprofile-use= */
  OPT_fprofile_values = 870,                 /* -fprofile-values */
  OPT_fprotect_parens = 871,                 /* -fprotect-parens */
  OPT_frandom_seed = 872,                    /* -frandom-seed */
  OPT_frandom_seed_ = 873,                   /* -frandom-seed= */
  OPT_frange_check = 874,                    /* -frange-check */
  OPT_freal_4_real_10 = 875,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 876,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 877,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 878,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 879,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 880,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 881,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 882,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 883,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 884,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 885,                /* -frecord-marker=8 */
  OPT_frecursive = 886,                      /* -frecursive */
  OPT_freduced_reflection = 887,             /* -freduced-reflection */
  OPT_free = 888,                            /* -free */
  OPT_freg_struct_return = 889,              /* -freg-struct-return */
  /* OPT_fregmove = 890, */                  /* -fregmove */
  OPT_frename_registers = 891,               /* -frename-registers */
  OPT_freorder_blocks = 892,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 893,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 894,              /* -freorder-functions */
  OPT_frepack_arrays = 895,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 896,           /* -freplace-objc-classes */
  OPT_frepo = 897,                           /* -frepo */
  OPT_freport_bug = 898,                     /* -freport-bug */
  OPT_frequire_return_statement = 899,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 900,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 901, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 902,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 903,                    /* -fresolution= */
  OPT_frounding_math = 904,                  /* -frounding-math */
  OPT_frtti = 905,                           /* -frtti */
  OPT_fsanitize_recover = 906,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 907,              /* -fsanitize-recover= */
  OPT_fsanitize_undefined_trap_on_error = 908,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 909,                      /* -fsanitize= */
  OPT_fsaw_java_file = 910,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 911,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 912,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 913,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 914,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 915,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 916,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 917,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 918,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 919,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 920,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 921,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 922,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 923,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 924,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 925,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 926,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 927,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 928, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 929,                /* -fschedule-fusion */
  OPT_fschedule_insns = 930,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 931,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 932,              /* -fsecond-underscore */
  OPT_fsection_anchors = 933,                /* -fsection-anchors */
  /* OPT_fsee = 934, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 935,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 936,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 937, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 938,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 939,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 940,         /* -fsemantic-interposition */
  OPT_fshort_double = 941,                   /* -fshort-double */
  OPT_fshort_enums = 942,                    /* -fshort-enums */
  OPT_fshort_wchar = 943,                    /* -fshort-wchar */
  OPT_fshow_column = 944,                    /* -fshow-column */
  OPT_fshrink_wrap = 945,                    /* -fshrink-wrap */
  OPT_fsign_zero = 946,                      /* -fsign-zero */
  OPT_fsignaling_nans = 947,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 948,               /* -fsigned-bitfields */
  OPT_fsigned_char = 949,                    /* -fsigned-char */
  OPT_fsigned_zeros = 950,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 951,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 952,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 953,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 954,               /* -fsource-filename= */
  OPT_fsource_ = 955,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 956,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 957,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 958,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 959, */                 /* -fsquangle */
  OPT_fssa_phiopt = 960,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 961,                   /* -fstack-arrays */
  /* OPT_fstack_check = 962, */              /* -fstack-check */
  OPT_fstack_check_ = 963,                   /* -fstack-check= */
  OPT_fstack_limit = 964,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 965,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 966,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 967,                /* -fstack-protector */
  OPT_fstack_protector_all = 968,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 969,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 970,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 971,                   /* -fstack-reuse= */
  OPT_fstack_usage = 972,                    /* -fstack-usage */
  OPT_fstats = 973,                          /* -fstats */
  OPT_fstdarg_opt = 974,                     /* -fstdarg-opt */
  OPT_fstore_check = 975,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 976, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 977,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 978,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 979,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 980, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 981,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 982,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 983,                    /* -fsyntax-only */
  OPT_ftabstop_ = 984,                       /* -ftabstop= */
  /* OPT_ftarget_help = 985, */              /* -ftarget-help */
  OPT_ftarget_ = 986,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 987,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 988, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 989,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 990,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 991, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 992,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 993,             /* -fthreadsafe-statics */
  OPT_ftime_report = 994,                    /* -ftime-report */
  OPT_ftls_model_ = 995,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 996,               /* -ftoplevel-reorder */
  OPT_ftracer = 997,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 998,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 999,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1000,                 /* -ftrapping-math */
  OPT_ftrapv = 1001,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1002,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1003,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1004,                      /* -ftree-ccp */
  OPT_ftree_ch = 1005,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1006,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1007,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1008,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1009,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1010,                   /* -ftree-cselim */
  OPT_ftree_dce = 1011,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1012,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1013,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1014,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1015,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1016, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1017,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1018,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1019,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1020,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1021,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1022, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1023,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1024,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1025,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1026,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1027,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1028,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1029,                      /* -ftree-pre */
  OPT_ftree_pta = 1030,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1031,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1032, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1033,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1034,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1035,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1036,                     /* -ftree-slsr */
  OPT_ftree_sra = 1037,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1038, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1039, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1040,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1041,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1042,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1043, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1044,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1045, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1046,                      /* -ftree-vrp */
  OPT_funderscoring = 1047,                  /* -funderscoring */
  OPT_funit_at_a_time = 1048,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1049,              /* -funroll-all-loops */
  OPT_funroll_loops = 1050,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1051,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1052,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1053,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1054,                 /* -funsigned-char */
  OPT_funswitch_loops = 1055,                /* -funswitch-loops */
  OPT_funwind_tables = 1056,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1057,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1058,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1059,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1060,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1061,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1062,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1063,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1064,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1065,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1066,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1067,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1068,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1069,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1070, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1071,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1072,                   /* -fverbose-asm */
  /* OPT_fversion = 1073, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1074,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1075,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1076,                   /* -fvisibility= */
  OPT_fvpt = 1077,                           /* -fvpt */
  /* OPT_fvtable_gc = 1078, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1079, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1080,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1081,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1082,                     /* -fvtv-debug */
  OPT_fweak = 1083,                          /* -fweak */
  OPT_fweb = 1084,                           /* -fweb */
  /* OPT_fwhole_file = 1085, */              /* -fwhole-file */
  OPT_fwhole_program = 1086,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1087,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1088,             /* -fworking-directory */
  OPT_fwpa = 1089,                           /* -fwpa */
  OPT_fwpa_ = 1090,                          /* -fwpa= */
  OPT_fwrapv = 1091,                         /* -fwrapv */
  /* OPT_fxref = 1092, */                    /* -fxref */
  /* OPT_fzee = 1093, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1094,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1095,                     /* -fzero-link */
  OPT_g = 1096,                              /* -g */
  OPT_gant = 1097,                           /* -gant */
  OPT_gcoff = 1098,                          /* -gcoff */
  OPT_gdwarf = 1099,                         /* -gdwarf */
  OPT_gdwarf_ = 1100,                        /* -gdwarf- */
  OPT_gen_decls = 1101,                      /* -gen-decls */
  OPT_ggdb = 1102,                           /* -ggdb */
  OPT_ggnu_pubnames = 1103,                  /* -ggnu-pubnames */
  OPT_gnat = 1104,                           /* -gnat */
  OPT_gnatO = 1105,                          /* -gnatO */
  OPT_gno_pubnames = 1106,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1107,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1108,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1109,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1110,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1111,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1112,                   /* -gsplit-dwarf */
  OPT_gstabs = 1113,                         /* -gstabs */
  OPT_gstabs_ = 1114,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1115,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1116,                        /* -gtoggle */
  OPT_gvms = 1117,                           /* -gvms */
  OPT_gxcoff = 1118,                         /* -gxcoff */
  OPT_gxcoff_ = 1119,                        /* -gxcoff+ */
  OPT_gz = 1120,                             /* -gz */
  OPT_gz_ = 1121,                            /* -gz= */
  OPT_h = 1122,                              /* -h */
  OPT_idirafter = 1123,                      /* -idirafter */
  OPT_imacros = 1124,                        /* -imacros */
  OPT_imultiarch = 1125,                     /* -imultiarch */
  OPT_imultilib = 1126,                      /* -imultilib */
  OPT_include = 1127,                        /* -include */
  OPT_iplugindir_ = 1128,                    /* -iplugindir= */
  OPT_iprefix = 1129,                        /* -iprefix */
  OPT_iquote = 1130,                         /* -iquote */
  OPT_isysroot = 1131,                       /* -isysroot */
  OPT_isystem = 1132,                        /* -isystem */
  OPT_iwithprefix = 1133,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1134,              /* -iwithprefixbefore */
  OPT_k8 = 1135,                             /* -k8 */
  OPT_l = 1136,                              /* -l */
  OPT_lang_asm = 1137,                       /* -lang-asm */
  OPT_m128bit_long_double = 1138,            /* -m128bit-long-double */
  OPT_m16 = 1139,                            /* -m16 */
  OPT_m32 = 1140,                            /* -m32 */
  OPT_m3dnow = 1141,                         /* -m3dnow */
  OPT_m3dnowa = 1142,                        /* -m3dnowa */
  OPT_m64 = 1143,                            /* -m64 */
  OPT_m80387 = 1144,                         /* -m80387 */
  OPT_m8bit_idiv = 1145,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1146,             /* -m96bit-long-double */
  OPT_mabi_ = 1147,                          /* -mabi= */
  OPT_mabm = 1148,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1149,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1150,                 /* -maddress-mode= */
  OPT_madx = 1151,                           /* -madx */
  OPT_maes = 1152,                           /* -maes */
  OPT_malign_data_ = 1153,                   /* -malign-data= */
  OPT_malign_double = 1154,                  /* -malign-double */
  OPT_malign_functions_ = 1155,              /* -malign-functions= */
  OPT_malign_jumps_ = 1156,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1157,                  /* -malign-loops= */
  OPT_malign_stringops = 1158,               /* -malign-stringops */
  OPT_mandroid = 1159,                       /* -mandroid */
  OPT_march_ = 1160,                         /* -march= */
  OPT_masm_ = 1161,                          /* -masm= */
  OPT_mavx = 1162,                           /* -mavx */
  OPT_mavx2 = 1163,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1164,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1165,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1166,                      /* -mavx512bw */
  OPT_mavx512cd = 1167,                      /* -mavx512cd */
  OPT_mavx512dq = 1168,                      /* -mavx512dq */
  OPT_mavx512er = 1169,                      /* -mavx512er */
  OPT_mavx512f = 1170,                       /* -mavx512f */
  OPT_mavx512ifma = 1171,                    /* -mavx512ifma */
  OPT_mavx512pf = 1172,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1173,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1174,                      /* -mavx512vl */
  OPT_mbionic = 1175,                        /* -mbionic */
  OPT_mbmi = 1176,                           /* -mbmi */
  OPT_mbmi2 = 1177,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1178,                  /* -mbranch-cost= */
  OPT_mcld = 1179,                           /* -mcld */
  OPT_mclflushopt = 1180,                    /* -mclflushopt */
  OPT_mclwb = 1181,                          /* -mclwb */
  OPT_mcmodel_ = 1182,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1183, */                    /* -mcpu= */
  OPT_mcrc32 = 1184,                         /* -mcrc32 */
  OPT_mcx16 = 1185,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1186,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1187,            /* -mdump-tune-features */
  OPT_mf16c = 1188,                          /* -mf16c */
  OPT_mfancy_math_387 = 1189,                /* -mfancy-math-387 */
  OPT_mfentry = 1190,                        /* -mfentry */
  OPT_mfma = 1191,                           /* -mfma */
  OPT_mfma4 = 1192,                          /* -mfma4 */
  OPT_mforce_drap = 1193,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1194,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1195,                       /* -mfpmath= */
  OPT_mfsgsbase = 1196,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1197, */              /* -mfused-madd */
  OPT_mfxsr = 1198,                          /* -mfxsr */
  OPT_mglibc = 1199,                         /* -mglibc */
  OPT_mhard_float = 1200,                    /* -mhard-float */
  OPT_mhle = 1201,                           /* -mhle */
  OPT_mieee_fp = 1202,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1203,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1204,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1205,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1206, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1207,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1208,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1209,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1210,                /* -mlong-double-80 */
  OPT_mlwp = 1211,                           /* -mlwp */
  OPT_mlzcnt = 1212,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1213,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1214,              /* -mmemset-strategy= */
  OPT_mmmx = 1215,                           /* -mmmx */
  OPT_mmovbe = 1216,                         /* -mmovbe */
  OPT_mmpx = 1217,                           /* -mmpx */
  OPT_mms_bitfields = 1218,                  /* -mms-bitfields */
  OPT_mmusl = 1219,                          /* -mmusl */
  OPT_mmwaitx = 1220,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1221,            /* -mno-align-stringops */
  OPT_mno_default = 1222,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1223,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1224,                  /* -mno-push-args */
  OPT_mno_red_zone = 1225,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1226,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1227,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1228,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1229,                          /* -mpc32 */
  OPT_mpc64 = 1230,                          /* -mpc64 */
  OPT_mpc80 = 1231,                          /* -mpc80 */
  OPT_mpclmul = 1232,                        /* -mpclmul */
  OPT_mpcommit = 1233,                       /* -mpcommit */
  OPT_mpopcnt = 1234,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1235,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1236,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1237,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1238,                        /* -mprfchw */
  OPT_mpush_args = 1239,                     /* -mpush-args */
  OPT_mrdrnd = 1240,                         /* -mrdrnd */
  OPT_mrdseed = 1241,                        /* -mrdseed */
  OPT_mrecip = 1242,                         /* -mrecip */
  OPT_mrecip_ = 1243,                        /* -mrecip= */
  OPT_mrecord_mcount = 1244,                 /* -mrecord-mcount */
  OPT_mred_zone = 1245,                      /* -mred-zone */
  OPT_mregparm_ = 1246,                      /* -mregparm= */
  OPT_mrtd = 1247,                           /* -mrtd */
  OPT_mrtm = 1248,                           /* -mrtm */
  OPT_msahf = 1249,                          /* -msahf */
  OPT_msha = 1250,                           /* -msha */
  OPT_mskip_rax_setup = 1251,                /* -mskip-rax-setup */
  OPT_msoft_float = 1252,                    /* -msoft-float */
  OPT_msse = 1253,                           /* -msse */
  OPT_msse2 = 1254,                          /* -msse2 */
  OPT_msse2avx = 1255,                       /* -msse2avx */
  OPT_msse3 = 1256,                          /* -msse3 */
  OPT_msse4 = 1257,                          /* -msse4 */
  OPT_msse4_1 = 1258,                        /* -msse4.1 */
  OPT_msse4_2 = 1259,                        /* -msse4.2 */
  OPT_msse4a = 1260,                         /* -msse4a */
  /* OPT_msse5 = 1261, */                    /* -msse5 */
  OPT_msseregparm = 1262,                    /* -msseregparm */
  OPT_mssse3 = 1263,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1264,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1265,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1266,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1267,            /* -mstringop-strategy= */
  OPT_mtbm = 1268,                           /* -mtbm */
  OPT_mtls_dialect_ = 1269,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1270,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1271,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1272,                         /* -mtune= */
  OPT_muclibc = 1273,                        /* -muclibc */
  OPT_mveclibabi_ = 1274,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1275,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1276,                    /* -mvzeroupper */
  OPT_mx32 = 1277,                           /* -mx32 */
  OPT_mxop = 1278,                           /* -mxop */
  OPT_mxsave = 1279,                         /* -mxsave */
  OPT_mxsavec = 1280,                        /* -mxsavec */
  OPT_mxsaveopt = 1281,                      /* -mxsaveopt */
  OPT_mxsaves = 1282,                        /* -mxsaves */
  OPT_n = 1283,                              /* -n */
  OPT_no_canonical_prefixes = 1284,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1285,              /* -no-integrated-cpp */
  OPT_nocpp = 1286,                          /* -nocpp */
  OPT_nodefaultlibs = 1287,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1288,                   /* -nostartfiles */
  OPT_nostdinc = 1289,                       /* -nostdinc */
  OPT_nostdinc__ = 1290,                     /* -nostdinc++ */
  OPT_nostdlib = 1291,                       /* -nostdlib */
  OPT_nostdlib__ = 1292,                     /* -nostdlib++ */
  OPT_o = 1293,                              /* -o */
  OPT_p = 1294,                              /* -p */
  OPT_pass_exit_codes = 1295,                /* -pass-exit-codes */
  /* OPT_pedantic = 1296, */                 /* -pedantic */
  OPT_pedantic_errors = 1297,                /* -pedantic-errors */
  OPT_pg = 1298,                             /* -pg */
  OPT_pie = 1299,                            /* -pie */
  OPT_pipe = 1300,                           /* -pipe */
  OPT_posix = 1301,                          /* -posix */
  OPT_print_file_name_ = 1302,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1303,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1304,          /* -print-multi-directory */
  OPT_print_multi_lib = 1305,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1306,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1307,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1308,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1309,               /* -print-prog-name= */
  OPT_print_search_dirs = 1310,              /* -print-search-dirs */
  OPT_print_sysroot = 1311,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1312,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1313,                        /* -profile */
  OPT_pthread = 1314,                        /* -pthread */
  OPT_quiet = 1315,                          /* -quiet */
  OPT_r = 1316,                              /* -r */
  OPT_rdynamic = 1317,                       /* -rdynamic */
  OPT_remap = 1318,                          /* -remap */
  OPT_s = 1319,                              /* -s */
  OPT_s_bc_abi = 1320,                       /* -s-bc-abi */
  OPT_save_temps = 1321,                     /* -save-temps */
  OPT_save_temps_ = 1322,                    /* -save-temps= */
  OPT_shared = 1323,                         /* -shared */
  OPT_shared_libgcc = 1324,                  /* -shared-libgcc */
  /* OPT_specs = 1325, */                    /* -specs */
  OPT_specs_ = 1326,                         /* -specs= */
  OPT_static = 1327,                         /* -static */
  OPT_static_libasan = 1328,                 /* -static-libasan */
  OPT_static_libgcc = 1329,                  /* -static-libgcc */
  OPT_static_libgcj = 1330,                  /* -static-libgcj */
  OPT_static_libgfortran = 1331,             /* -static-libgfortran */
  OPT_static_libgo = 1332,                   /* -static-libgo */
  OPT_static_liblsan = 1333,                 /* -static-liblsan */
  OPT_static_libmpx = 1334,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1335,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1336,               /* -static-libstdc++ */
  OPT_static_libtsan = 1337,                 /* -static-libtsan */
  OPT_static_libubsan = 1338,                /* -static-libubsan */
  /* OPT_std_c__03 = 1339, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1340, */                /* -std=c++0x */
  OPT_std_c__11 = 1341,                      /* -std=c++11 */
  OPT_std_c__14 = 1342,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1343, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1344, */                /* -std=c++1y */
  OPT_std_c__1z = 1345,                      /* -std=c++1z */
  OPT_std_c__98 = 1346,                      /* -std=c++98 */
  OPT_std_c11 = 1347,                        /* -std=c11 */
  /* OPT_std_c1x = 1348, */                  /* -std=c1x */
  /* OPT_std_c89 = 1349, */                  /* -std=c89 */
  OPT_std_c90 = 1350,                        /* -std=c90 */
  OPT_std_c99 = 1351,                        /* -std=c99 */
  /* OPT_std_c9x = 1352, */                  /* -std=c9x */
  OPT_std_f2003 = 1353,                      /* -std=f2003 */
  OPT_std_f2008 = 1354,                      /* -std=f2008 */
  OPT_std_f2008ts = 1355,                    /* -std=f2008ts */
  OPT_std_f95 = 1356,                        /* -std=f95 */
  OPT_std_gnu = 1357,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1358, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1359, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1360,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1361,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1362, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1363, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1364,                    /* -std=gnu++1z */
  ...
  OPT_symbolic = 1378,                       /* -symbolic */
  OPT_t = 1379,                              /* -t */
  OPT_time = 1380,                           /* -time */
  OPT_time_ = 1381,                          /* -time= */
  OPT_tno_android_cc = 1382,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1383,                 /* -tno-android-ld */
  OPT_traditional = 1384,                    /* -traditional */
  OPT_traditional_cpp = 1385,                /* -traditional-cpp */
  OPT_trigraphs = 1386,                      /* -trigraphs */
  OPT_u = 1387,                              /* -u */
  OPT_undef = 1388,                          /* -undef */
  OPT_v = 1389,                              /* -v */
  OPT_version = 1390,                        /* -version */
  OPT_w = 1391,                              /* -w */
  OPT_wrapper = 1392,                        /* -wrapper */
  OPT_x = 1393,                              /* -x */
  OPT_z = 1394,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
