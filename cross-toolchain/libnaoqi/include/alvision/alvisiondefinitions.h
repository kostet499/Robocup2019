...
namespace AL
{
  ...
  */
  ...
  const int kOV5640  = 3;
  const int kXTION   = 4;
  const int kSimulator2D = 5;
  const int kSimulator3D = 6;
  const int kStereo = 7;
  const int kOV4689 = 8;
  ...
  */
  ...
  const int kLabColorSpace = 22;
  const int kRawDepthColorSpace = 23; //!< @since 2.2
  const int kLuvColorSpace = 24;
  const int kLChabColorSpace = 25;
  const int kLChuvColorSpace = 26;
  ...
  const int kCameraSynchronisationID = 41; //!< @since 2.3
  const int kCameraDisparityWindowSizeID = 42; //!< @since 2.3
  const int kCameraFocusID = 43; //!< @since 2.5
  const int kCameraTestPatternID = 44; //!< @since 2.7
