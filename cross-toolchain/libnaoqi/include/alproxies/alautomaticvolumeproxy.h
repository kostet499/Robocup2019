// Generated for ALAutomaticVolume version 0

#ifndef ALAUTOMATICVOLUMEPROXY_H_
#define ALAUTOMATICVOLUMEPROXY_H_
...
namespace AL
{
  class ALBroker;
  class ALProxy;
  class ALAutomaticVolumeProxy;

  namespace detail {
    class ALAutomaticVolumeProxyPostHandler
    {
    protected:
      ALAutomaticVolumeProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALAutomaticVolumeProxy;
      ...
      int enableVolumeAdaptation(const bool& arg1);
  ...
  public:
    ...
    ALAutomaticVolumeProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALAutomaticVolumeProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALAutomaticVolumeProxy(const std::string &ip, int port=9559);
    ...
    /// </summary>
    /// <param name="arg1"> arg </param>
    void enableVolumeAdaptation(const bool& arg1);
    ...
    detail::ALAutomaticVolumeProxyPostHandler post;
  };

}
#endif // ALAUTOMATICVOLUMEPROXY_H_
