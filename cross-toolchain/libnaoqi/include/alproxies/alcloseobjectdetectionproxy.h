// Generated for ALCloseObjectDetection version 0

#ifndef ALCLOSEOBJECTDETECTIONPROXY_H_
#define ALCLOSEOBJECTDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALCloseObjectDetectionProxyPostHandler
    {
    protected:
      ALCloseObjectDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALCloseObjectDetectionProxy;
  ...
  public:
    ...
    ALCloseObjectDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALCloseObjectDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALCloseObjectDetectionProxy(const std::string &ip, int port=9559);
    ...
    detail::ALCloseObjectDetectionProxyPostHandler post;
  };

}
#endif // ALCLOSEOBJECTDETECTIONPROXY_H_
