...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// </summary>
      /// <param name="pAcceleration"> The maximum acceleration in rad.s-2 . </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setMaximumAcceleration(const float& pAcceleration);
      ...
      /// </summary>
      /// <param name="pVelocity"> The maximum velocity in rad.s-1 . </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setMaximumVelocity(const float& pVelocity);
      ...
      /// </summary>
      /// <param name="pFractionMaxSpeed"> a fraction max speed. </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setSearchFractionMaxSpeed(const float& pFractionMaxSpeed);
  ...
  public:
    ...
    float getSearchFractionMaxSpeed();
    ...
    /// </summary>
    /// <param name="pAcceleration"> The maximum acceleration in rad.s-2 . </param>
    void setMaximumAcceleration(const float& pAcceleration);
    ...
    /// </summary>
    /// <param name="pVelocity"> The maximum velocity in rad.s-1 . </param>
    void setMaximumVelocity(const float& pVelocity);
    ...
    /// </summary>
    /// <param name="pFractionMaxSpeed"> a fraction max speed. </param>
    void setSearchFractionMaxSpeed(const float& pFractionMaxSpeed);
