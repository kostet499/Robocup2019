// Generated for ALVisualSpaceHistory version 0

#ifndef ALVISUALSPACEHISTORYPROXY_H_
#define ALVISUALSPACEHISTORYPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALVisualSpaceHistoryProxyPostHandler
    {
    protected:
      ALVisualSpaceHistoryProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALVisualSpaceHistoryProxy;
      ...
      /// Sets grid precision
      /// </summary>
      /// <param name="precision"> float, ratio between camera field of view and grid cell field of view in each dimension. Setting the grid precision will reset the grid. </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setGridPrecision(const float& precision);
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALVisualSpaceHistoryProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALVisualSpaceHistoryProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALVisualSpaceHistoryProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALVisualSpaceHistoryProxy(const std::string &ip, int port=9559);
    ...
    /// </summary>
    /// <param name="precision"> float, ratio between camera field of view and grid cell field of view in each dimension. Setting the grid precision will reset the grid. </param>
    void setGridPrecision(const float& precision);
    ...
    detail::ALVisualSpaceHistoryProxyPostHandler post;
  };

}
#endif // ALVISUALSPACEHISTORYPROXY_H_
