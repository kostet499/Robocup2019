// Generated for ALBacklightingDetection version 0

#ifndef ALBACKLIGHTINGDETECTIONPROXY_H_
#define ALBACKLIGHTINGDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALBacklightingDetectionProxyPostHandler
    {
    protected:
      ALBacklightingDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALBacklightingDetectionProxy;
  ...
  public:
    ...
    ALBacklightingDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALBacklightingDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALBacklightingDetectionProxy(const std::string &ip, int port=9559);
    ...
    detail::ALBacklightingDetectionProxyPostHandler post;
  };

}
#endif // ALBACKLIGHTINGDETECTIONPROXY_H_
