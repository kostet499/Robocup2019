...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <param name="times"> An ragged ALValue matrix of floats. Each line corresponding to a motor, and column element to a control point. </param>
      /// <param name="controlPoints"> An ALValue array of arrays each containing [float angle, Handle1, Handle2], where Handle is [int InterpolationType, float dAngle, float dTime] descibing the handle offsets relative to the angle and time of the point. The first bezier param describes the handle that controls the curve preceeding the point, the second describes the curve following the point. </param>
      /// <param name="isAbsolute"> A bool or a vector of bool. If true, the movement is described in absolute angles, else the angles are relative to the current angle. </param>
      /// <param name="supportSequence"> An alvalue containing a list of [nameEffector, timeList, isActiveList]. </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int animation(const std::vector<std::string>& jointNames, const AL::ALValue& times, const AL::ALValue& controlPoints, const AL::ALValue& isAbsolute, const AL::ALValue& supportSequence);
      ...
      /// <param name="names"> The name or names of joints, chains, "Body", "JointActuators", "Joints" or "Actuators".  </param>
      /// <param name="angles"> One or more angles in radians </param>
      /// <param name="fractionMaxSpeeds"> The vector of fraction of maximum speed to use </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setAngles(const AL::ALValue& names, const AL::ALValue& angles, const std::vector<float>& fractionMaxSpeeds);
      ...
      /// </summary>
      /// <param name="isEnable"> Enable Robot to keep balance. </param>
  ...
  public:
    ...
    /// <param name="isAbsolute"> A bool or a vector of bool. If true, the movement is described in absolute angles, else the angles are relative to the current angle. </param>
    /// <param name="supportSequence"> An alvalue containing a list of [nameEffector, timeList, isActiveList]. </param>
    void animation(const std::vector<std::string>& jointNames, const AL::ALValue& times, const AL::ALValue& controlPoints, const AL::ALValue& isAbsolute, const AL::ALValue& supportSequence);
    ...
    std::vector<std::vector<float> > getSupportPolygon(const int& pSpace, const bool& pUseSensorValues);
    ...
    /// <param name="angles"> One or more angles in radians </param>
    /// <param name="fractionMaxSpeeds"> The vector of fraction of maximum speed to use </param>
    void setAngles(const AL::ALValue& names, const AL::ALValue& angles, const std::vector<float>& fractionMaxSpeeds);
    ...
    bool wbGoToBalance(const std::string& supportLeg, const float& duration);
    ...
    /// <param name="fractionMaxSpeed"> The fraction of maximum speed to use. </param>
    /// <returns> A boolean of the success of the go to balance. </returns>
    bool wbGoToBalanceWithSpeed(const std::string& supportLeg, const float& fractionMaxSpeed);
