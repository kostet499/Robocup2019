// Generated for ALFaceTracker version 0
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALFaceTrackerProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALFaceTrackerProxy;
  ...
  public:
    ...
    ALFaceTrackerProxy(const std::string &ip, int port=9559);
    ...
    detail::ALFaceTrackerProxyPostHandler post;
  };
