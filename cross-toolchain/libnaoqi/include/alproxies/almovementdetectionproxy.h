// Generated for ALMovementDetection version 0

#ifndef ALMOVEMENTDETECTIONPROXY_H_
#define ALMOVEMENTDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALMovementDetectionProxyPostHandler
    {
    protected:
      ALMovementDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALMovementDetectionProxy;
      ...
      /// </summary>
      /// <param name="sensitivity"> New color sensitivity (between 0 and 1) </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setColorSensitivity(const float& sensitivity);
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALMovementDetectionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALMovementDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALMovementDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALMovementDetectionProxy(const std::string &ip, int port=9559);
    ...
    /// </summary>
    /// <param name="sensitivity"> New color sensitivity (between 0 and 1) </param>
    void setColorSensitivity(const float& sensitivity);
    ...
    /// </summary>
    /// <param name="value"> New framerate </param>
    /// <returns> True if the update succeeded, False if not </returns>
    ...
    detail::ALMovementDetectionProxyPostHandler post;
  };

}
#endif // ALMOVEMENTDETECTIONPROXY_H_
