// Generated for ALPythonBridge version 0
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALPythonBridgeProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALPythonBridgeProxy;
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALPythonBridgeProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALPythonBridgeProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALPythonBridgeProxy(const std::string &ip, int port=9559);
    ...
    detail::ALPythonBridgeProxyPostHandler post;
  };
