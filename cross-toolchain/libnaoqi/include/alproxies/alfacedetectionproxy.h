// Generated for ALFaceDetection version 0
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALFaceDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALFaceDetectionProxy;
      ...
      int enableRecognition(const bool& arg1);
      ...
      /// <param name="arg1"> arg </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int enableTracking(const bool& arg1);
      ...
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setRecognitionEnabled(const bool& enable);
      ...
      /// <param name="enable"> True/False </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setTrackingEnabled(const bool& enable);
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALFaceDetectionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALFaceDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALFaceDetectionProxy(const std::string &ip, int port=9559);
    ...
    /// </summary>
    /// <param name="arg1"> arg </param>
    void enableRecognition(const bool& arg1);

    /// <summary>
    /// deprecated
    /// </summary>
    /// <param name="arg1"> arg </param>
    void enableTracking(const bool& arg1);
    ...
    AL::ALValue getLearnedFacesList();
    ...
    /// </summary>
    /// <param name="policy"> Merging policy if an imported entry has the same name as an existing one.
    /// It can be either:
    ...
    /// "keep" to keep the existing entry and skip the imported one. </param>
    /// <returns> True if the import succeeded, false otherwise. </returns>
    bool importOldDatabase(const std::string& policy);
    ...
    /// </summary>
    /// <param name="enable"> True/False </param>
    void setRecognitionEnabled(const bool& enable);
    ...
    /// </summary>
    /// <param name="enable"> True/False </param>
    void setTrackingEnabled(const bool& enable);
    ...
    detail::ALFaceDetectionProxyPostHandler post;
  };
