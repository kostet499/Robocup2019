// Generated for ALSittingPeopleDetection version 0

#ifndef ALSITTINGPEOPLEDETECTIONPROXY_H_
#define ALSITTINGPEOPLEDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALSittingPeopleDetectionProxyPostHandler
    {
    protected:
      ALSittingPeopleDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALSittingPeopleDetectionProxy;
      ...
      /// </summary>
      /// <param name="threshold"> float, face height (in meter) from the ground under which we consider thatsomeone is sitting. </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setSittingThreshold(const float& threshold);
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALSittingPeopleDetectionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALSittingPeopleDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALSittingPeopleDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALSittingPeopleDetectionProxy(const std::string &ip, int port=9559);
    ...
    /// </summary>
    /// <param name="threshold"> float, face height (in meter) from the ground under which we consider thatsomeone is sitting. </param>
    void setSittingThreshold(const float& threshold);
    ...
    detail::ALSittingPeopleDetectionProxyPostHandler post;
  };

}
#endif // ALSITTINGPEOPLEDETECTIONPROXY_H_
