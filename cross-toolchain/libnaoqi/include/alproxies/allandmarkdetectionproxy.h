// Generated for ALLandMarkDetection version 0

#ifndef ALLANDMARKDETECTIONPROXY_H_
#define ALLANDMARKDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALLandMarkDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALLandMarkDetectionProxy;
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALLandMarkDetectionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALLandMarkDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALLandMarkDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALLandMarkDetectionProxy(const std::string &ip, int port=9559);
    ...
    detail::ALLandMarkDetectionProxyPostHandler post;
  };

}
#endif // ALLANDMARKDETECTIONPROXY_H_
