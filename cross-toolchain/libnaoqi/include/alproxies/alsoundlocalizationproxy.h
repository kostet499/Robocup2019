// Generated for ALSoundLocalization version 0

#ifndef ALSOUNDLOCALIZATIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALSoundLocalizationProxyPostHandler
    {
    protected:
      ALSoundLocalizationProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALSoundLocalizationProxy;
      ...
      /// </summary>
      /// <param name="parameter"> Name of the parameter. "Sensibility" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. "EnergyComputation" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the "ALSoundLocalization/SoundLocated" ALMemory key. </param>
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALSoundLocalizationProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALSoundLocalizationProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALSoundLocalizationProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALSoundLocalizationProxy(const std::string &ip, int port=9559);
    ...
    detail::ALSoundLocalizationProxyPostHandler post;
  };

}
#endif // ALSOUNDLOCALIZATIONPROXY_H_
