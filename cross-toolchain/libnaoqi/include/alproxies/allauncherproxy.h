// Generated for ALLauncher version 0
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALLauncherProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALLauncherProxy;
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALLauncherProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALLauncherProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALLauncherProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALLauncherProxy(const std::string &ip, int port=9559);
    ...
    detail::ALLauncherProxyPostHandler post;
  };
