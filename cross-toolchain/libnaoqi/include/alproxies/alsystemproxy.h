...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <param name="new2"> password The new user password. </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int changePassword(const std::string& old, const std::string& new2);
  ...
  public:
    ...
    /// </summary>
    /// <param name="old"> password The current password of the user. </param>
    /// <param name="new"> password The new user password. </param>
    void changePassword(const std::string& old, const std::string& new2);
