// Generated for ALSensors version 0

#ifndef ALSENSORSPROXY_H_
#define ALSENSORSPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALSensorsProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALSensorsProxy;
  ...
  public:
    ...
    ALSensorsProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALSensorsProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALSensorsProxy(const std::string &ip, int port=9559);
    ...
    detail::ALSensorsProxyPostHandler post;
  };

}
#endif // ALSENSORSPROXY_H_
