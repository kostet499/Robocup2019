...
namespace AL
{
  ...
  public:
    ...
    /// </summary>
    /// <param name="desiredRadius"> The radius of the space we want in meters [m]. </param>
    /// <param name="maximumDisplacement"> The max distance we accept to move toreach the found place [m]. </param>
    /// <returns> Returns [errorCode, result radius (m), [worldMotionToRobotCenterX (m), worldMotionToRobotCenterY (m)]] </returns>
    AL::ALValue findFreeZone(const float& desiredRadius, const float& maximumDisplacement);
    ...
    /// <param name="maximumDisplacement"> The max distance we accept to move toreach the found place [m]. </param>
    /// <returns> Returns [errorCode, result radius (m), [worldMotionToRobotCenterX (m), worldMotionToRobotCenterY (m)]] </returns>
    AL::ALValue stopAndComputeFreeZone(const float& desiredRadius, const float& maximumDisplacement);
