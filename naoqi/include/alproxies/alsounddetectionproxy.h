// Generated for ALSoundDetection version 0
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALSoundDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALSoundDetectionProxy;
      ...
      /// </summary>
      /// <param name="parameter"> Name of the parameter. "Sensibility" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. "EnergyComputation" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the "ALSoundDetection/SoundLocated" ALMemory key. </param>
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALSoundDetectionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALSoundDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALSoundDetectionProxy(const std::string &ip, int port=9559);
    ...
    detail::ALSoundDetectionProxyPostHandler post;
  };
