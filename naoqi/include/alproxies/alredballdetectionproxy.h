// Generated for ALRedBallDetection version 0

#ifndef ALREDBALLDETECTIONPROXY_H_
#define ALREDBALLDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALRedBallDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALRedBallDetectionProxy;
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALRedBallDetectionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALRedBallDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALRedBallDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALRedBallDetectionProxy(const std::string &ip, int port=9559);
    ...
    detail::ALRedBallDetectionProxyPostHandler post;
  };

}
#endif // ALREDBALLDETECTIONPROXY_H_
