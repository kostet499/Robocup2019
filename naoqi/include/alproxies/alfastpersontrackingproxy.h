// Generated for ALFastPersonTracking version 0

#ifndef ALFASTPERSONTRACKINGPROXY_H_
#define ALFASTPERSONTRACKINGPROXY_H_
...
namespace AL
{
  class ALBroker;
  class ALProxy;
  class ALFastPersonTrackingProxy;

  namespace detail {
    class ALFastPersonTrackingProxyPostHandler
    {
    protected:
      ALFastPersonTrackingProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALFastPersonTrackingProxy;
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALFastPersonTrackingProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALFastPersonTrackingProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALFastPersonTrackingProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALFastPersonTrackingProxy(const std::string &ip, int port=9559);
    ...
    detail::ALFastPersonTrackingProxyPostHandler post;
  };

}
#endif // ALFASTPERSONTRACKINGPROXY_H_
