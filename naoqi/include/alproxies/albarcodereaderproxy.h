// Generated for ALBarcodeReader version 0

#ifndef ALBARCODEREADERPROXY_H_
#define ALBARCODEREADERPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALBarcodeReaderProxyPostHandler
    {
    protected:
      ALBarcodeReaderProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALBarcodeReaderProxy;
  ...
  public:
    ...
    ALBarcodeReaderProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALBarcodeReaderProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALBarcodeReaderProxy(const std::string &ip, int port=9559);
    ...
    detail::ALBarcodeReaderProxyPostHandler post;
  };

}
#endif // ALBARCODEREADERPROXY_H_
