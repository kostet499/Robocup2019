// Generated for ALAudioSourceLocalization version 0

#ifndef ALAUDIOSOURCELOCALIZATIONPROXY_H_
#define ALAUDIOSOURCELOCALIZATIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALAudioSourceLocalizationProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALAudioSourceLocalizationProxy;
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALAudioSourceLocalizationProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALAudioSourceLocalizationProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALAudioSourceLocalizationProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALAudioSourceLocalizationProxy(const std::string &ip, int port=9559);
    ...
    detail::ALAudioSourceLocalizationProxyPostHandler post;
  };
