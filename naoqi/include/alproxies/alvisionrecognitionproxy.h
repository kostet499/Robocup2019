// Generated for ALVisionRecognition version 0

#ifndef ALVISIONRECOGNITIONPROXY_H_
#define ALVISIONRECOGNITIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    ...
    {
    protected:
      ALVisionRecognitionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALVisionRecognitionProxy;
      ...
      /// </summary>
      /// <param name="paramName"> Name of the parameter to be changed. Only "resolution" can be used. </param>
      /// <param name="paramValue"> Value of the resolution as an integer: 0(QQVGA) 1(QVGA) 2(VGA) </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALVisionRecognitionProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALVisionRecognitionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALVisionRecognitionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALVisionRecognitionProxy(const std::string &ip, int port=9559);
    ...
    bool changeDatabase(const std::string& databasePath, const std::string& databaseName);
    ...
    /// </summary>
    /// <param name="paramName"> The name of the parameter to get. "db_path" and "db_name" can be used. </param>
    /// <returns> Value of the parameter as a string for "db_path" and "db_name" </returns>
    AL::ALValue getParam(const std::string& paramName);
    ...
    detail::ALVisionRecognitionProxyPostHandler post;
  };
