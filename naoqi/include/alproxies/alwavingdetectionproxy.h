// Generated for ALWavingDetection version 0

#ifndef ALWAVINGDETECTIONPROXY_H_
...
namespace AL
{
  ...
  namespace detail {
    class ALWavingDetectionProxyPostHandler
    {
    protected:
      ALWavingDetectionProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALWavingDetectionProxy;
      ...
      /// </summary>
      /// <param name="maxDistance"> New maximum distance (in meters), between 0.5m and 3m </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setMaxDistance(const float& maxDistance);

      /// <summary>
      /// Set minimum size of movement for waving detection
      /// </summary>
      /// <param name="sensitivity"> New minimum size (in meters), between 0.05m and 0.3m </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setMinSize(const float& sensitivity);
  ...
  public:
    ...
    ALWavingDetectionProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALWavingDetectionProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALWavingDetectionProxy(const std::string &ip, int port=9559);
    ...
    /// </summary>
    /// <param name="sensitivity"> New minimum size (in meters), between 0.05m and 0.3m </param>
    void setMinSize(const float& sensitivity);
    ...
    detail::ALWavingDetectionProxyPostHandler post;
  };

}
#endif // ALWAVINGDETECTIONPROXY_H_
