...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setDefaultInput(const qi::uint32_t& index);
      ...
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setDefaultOutput(const qi::uint32_t& index);
  ...
  public:
    ...
    qi::uint32_t defaultInput();

    /// <summary>
    /// return the default output
    /// </summary>
    /// <returns> The default output index </returns>
    qi::uint32_t defaultOutput();
    ...
    AL::ALValue input(const qi::uint32_t& index);
    ...
    AL::ALValue listInputs();

    /// <summary>
    /// return the list of available outputs
    /// </summary>
    /// <returns> A list of AudioDeviceInfo </returns>
    AL::ALValue listOutputs();
    ...
    /// <param name="index"> The output index </param>
    /// <returns> An AudioDeviceInfo </returns>
    AL::ALValue output(const qi::uint32_t& index);
    ...
    /// </summary>
    /// <param name="index"> The input index </param>
    void setDefaultInput(const qi::uint32_t& index);

    /// <summary>
    /// set the default output
    /// </summary>
    /// <param name="index"> The output index </param>
    void setDefaultOutput(const qi::uint32_t& index);
