...
SSL_MIN_YEAR = 2015 # Minimum System Year to allow a Request
...
class RequestManager(object):
    ...
    def request(self, method, url, data=None, as_json=True,
        ...
        """
        # Here is a protection to avoid any ArcSDK requests if the
        # system date year is bellow 2015. Since Python Requests has
        # a strange behavior in this case and raise sometimes SSLError
        # and sometimes ConnectionError. Now SSLError will be raised
        # Redmine : https://redmine.aldebaran.lan/issues/36419
        system_year = datetime.datetime.now().year
        if system_year < SSL_MIN_YEAR:
            raise SSLError("Request cancelled, system year is %s" % system_year)
