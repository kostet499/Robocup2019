...
set(Qt5NetworkAuth_VERSION_STRING 5.9.2)
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    foreach(_module_dep ${_Qt5NetworkAuth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.2 ${_Qt5NetworkAuth_FIND_VERSION_EXACT}
    ...
    _populate_NetworkAuth_target_properties(RELEASE "libQt5NetworkAuth.so.5.9.2" "" )
