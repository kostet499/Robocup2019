...
set(Qt5WebEngineWidgets_VERSION_STRING 5.9.2)
...
macro(_populate_WebEngineWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5WebEngineWidgets_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::WebEngineWidgets PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5WebEngineWidgets.so.5"
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    foreach(_module_dep ${_Qt5WebEngineWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.2 ${_Qt5WebEngineWidgets_FIND_VERSION_EXACT}
    ...
    _populate_WebEngineWidgets_target_properties(RELEASE "libQt5WebEngineWidgets.so.5.9.2" "" )
