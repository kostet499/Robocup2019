...
set(Qt5WebEngine_VERSION_STRING 5.9.2)
...
macro(_populate_WebEngine_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5WebEngine_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::WebEngine PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5WebEngine.so.5"
...
if (NOT TARGET Qt5::WebEngine)
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.2 ${_Qt5WebEngine_FIND_VERSION_EXACT}
    ...
    _populate_WebEngine_target_properties(RELEASE "libQt5WebEngine.so.5.9.2" "" )
