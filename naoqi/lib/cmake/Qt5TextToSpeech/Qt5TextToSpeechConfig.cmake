...
set(Qt5TextToSpeech_VERSION_STRING 5.9.2)
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    foreach(_module_dep ${_Qt5TextToSpeech_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.2 ${_Qt5TextToSpeech_FIND_VERSION_EXACT}
    ...
    _populate_TextToSpeech_target_properties(RELEASE "libQt5TextToSpeech.so.5.9.2" "" )
