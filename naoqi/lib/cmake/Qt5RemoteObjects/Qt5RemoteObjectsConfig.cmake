...
set(Qt5RemoteObjects_VERSION_STRING 5.9.2)
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    foreach(_module_dep ${_Qt5RemoteObjects_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.2 ${_Qt5RemoteObjects_FIND_VERSION_EXACT}
    ...
    _populate_RemoteObjects_target_properties(RELEASE "libQt5RemoteObjects.so.5.9.2" "" )
