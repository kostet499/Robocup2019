...
set(Qt5XmlPatterns_VERSION_STRING 5.9.2)
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    foreach(_module_dep ${_Qt5XmlPatterns_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.2 ${_Qt5XmlPatterns_FIND_VERSION_EXACT}
    ...
    _populate_XmlPatterns_target_properties(RELEASE "libQt5XmlPatterns.so.5.9.2" "" )
